...
class TripFragment : Fragment(), TencentLocationListener, LocationSource {
    ...
    private lateinit var shouyuButton: LinearLayout
...
//            startActivity(intent)
        ...
        shouyuButton.setOnClickListener {
            val intent = Intent(requireContext(), SignpalActivity::class.java)
            startActivity(intent)
        }
    ...
    private fun findViewById(root: View) {
        ...
        shouyuButton = root.findViewById(R.id.shouyu_button)
