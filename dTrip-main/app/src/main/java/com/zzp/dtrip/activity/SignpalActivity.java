...
import com.zzp.dtrip.util.Avatar;
import com.zzp.dtrip.util.AvatarPaint;
import com.zzp.dtrip.util.FrameData;

import java.util.ArrayList;
import java.util.Map;

public class SignpalActivity extends AppCompatActivity {
    private static String TAG = "DDLActivity";

    // please set your ApiKey or accessToken
    private String apikey ="CgF6e3x9L8tbJ7yLqpxTYQQhmiVvF4tdvG5CEqxrxMnm5EHxq2uBjzork9ye1W6tllgzBiZPHx1NxDQlD+B5fy3J" ;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.fragment_signpal);
